...
2) `huge`: 座標値が巨大なケース（ $N = 100$ ）; 15ケース
   - `huge-super-small`: 原点からの距離が $R \simeq 1 \times 10^{12}$ であるような領域中の点を中心とする、辺長 $5 \times 10^4$ の正方形上に分布する点群のケース; 5ケース
   - `huge-small`: 原点からの距離が $R \simeq 1 \times 10^{7}$ であるような領域中の点を中心とする、辺長 $5 \times 10^4$ の正方形上に分布する点群のケース; 5ケース
